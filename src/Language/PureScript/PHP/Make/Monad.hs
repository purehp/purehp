...
-- case that an IOExcecption is thrown.
...
-- | Get a file's modification time in the 'Make' monad, returing Nothing if
...
-- | Read an externs file, returing 'Nothing' if the file does not exist,
